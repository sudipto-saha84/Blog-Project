                ...
                <div class="col-lg-8 py-100">
                        ...
                        <div class="p-4">
                            ...
                            <div class="row mb-20">
                                <div class="col-sm-5 pr-sm-0 align-self-center">
                                    <img class="img-fluid w-100 rounded mr-4 mb-4 mb-sm-0" src="{{asset('/')}}front-assets/images/blog/blog-testimonial.jpg"
                                         alt="client image">
                                </div>
                                <div class="col-sm-7">
                    ...
                    <div>
                        ...
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                                <img class="img-fluid rounded w-100" src="{{asset('/')}}front-assets/images/blog/comment-1.jpg" alt="user-image">
                            </div>
                        ...
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                                <img class="img-fluid rounded w-100" src="{{asset('/')}}front-assets/images/blog/comment-2.jpg" alt="user-image">
                            </div>
                            <div class="border rounded py-3 px-4">
                                <div class="border-bottom mb-10">
                                    <h5>Mikymouse</h5>
